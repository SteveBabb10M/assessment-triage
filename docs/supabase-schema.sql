...
CREATE TABLE IF NOT EXISTS submissions (
  ...
  charrsids JSONB DEFAULT '[]'::jsonb,           -- charrsid values for cohort cross-referencing
...
-- GIN index on charrsids for efficient set intersection queries (cohort mode)
CREATE INDEX IF NOT EXISTS idx_submissions_charrsids ON submissions USING GIN (charrsids);
