...
export async function extractDocForensics(buffer) {
  ...
  return buildForensicReport(sections, documentDefaultFont, zip, documentProperties, settingsRsidCount, rsidtbl);
}

// ─── Report Builder ─────────────────────────────────────────

async function buildForensicReport(sections, documentDefaultFont, zip, documentProperties, settingsRsidCount, rsidtbl) {
